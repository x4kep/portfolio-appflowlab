...
export const gridItems = [
  ...
  {
    id: 2,
    title: "Flexible with communication across EST, CET, and MSK.",
    description: "",
  ...
  {
    id: 5,
    title: "Currently building ReactNative application for studing fast",
    description: "The Inside of appflowlab",
